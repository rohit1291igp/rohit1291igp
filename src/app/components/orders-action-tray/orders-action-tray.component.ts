          ...
          "result": [
              {
                  ...
                  "addressType": "Home",
                  "orderInstruction": "<BR><BR><B>IGP Instructions:&nbsp;</B><BR>#REFNW<BR><B>Product Name:&nbsp;</B>Half Kg Round Shape Pineapple Cake<BR><B>City:&nbsp;</B>Batala<BR><B>Product Code:&nbsp;</B>HD1031282<BR><B>Shipping Type:&nbsp;</B>Fix Date Delivery<BR><B>Quantity:&nbsp;</B>1<BR><B>Gift Box:&nbsp;</B>0<BR><B>Selected Attributes:&nbsp;</B>[]<BR><B>Shipping Date:&nbsp;</B>2017-05-13 |",
