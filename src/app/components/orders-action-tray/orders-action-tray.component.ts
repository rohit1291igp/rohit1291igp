    ...
    animations: [
        trigger('anim', [
            transition('* => void', [
                ...
                sequence([
                    animate(".4s ease", style({ height: '*', opacity: '.7', transform: 'translateX(99%)', 'box-shadow': 'none'  })),
                    animate("0.9s ease", style({ height: '0', opacity: 0, transform: 'translateX(99%)', 'box-shadow': 'none'  }))
                ])
            ]),
