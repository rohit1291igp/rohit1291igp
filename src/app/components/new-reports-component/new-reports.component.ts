...
import { MatDialog, MatDialogRef, MatSnackBar, MAT_DIALOG_DATA, MatSort, MatTableDataSource, MatPaginator } from '@angular/material';
    ...
    ngOnInit() {
        ...
        this.route.params.subscribe(params => {
            ...
            _this.reportsService.getReportData(_this.reportType, _this.queryString, function (error, _reportData) {
                ...
                _reportData.tableHeaders.forEach((e) => {
                    _this.columnNames.push({ id: e, value: e });
                })
                if (_this.columnNames.length > 0) {
                    _this.displayedColumns = _this.columnNames.map(x => x.id);
                }
