...
import { GiftsVoucherComponent } from './gifts-voucher.component';
...
describe('GiftsVoucherComponent', () => {
  let component: GiftsVoucherComponent;
  let fixture: ComponentFixture<GiftsVoucherComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [GiftsVoucherComponent],
      providers:[
        {
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(GiftsVoucherComponent);
  ...
  it('testtttt', () => {
    // const spy = spyOn(component, 'fetchVouchers').and.returnValue(coupondetails);
    component.fetchVouchers();
    expect(component.fetchVouchers()).toBeTruthy();
    expect(component.fetchVouchers).toHaveBeenCalled();
  });
